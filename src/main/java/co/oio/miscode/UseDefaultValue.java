 ...
 *
 * VolatileUseExplicitInitialization sample of the Benchmark results (JDK 12):
 * Benchmark                 Mode   Cnt           Score           Error  Units
 * UseExplicitValue          thrpt   25  3713078690.377 ±  23089789.596  ops/s
 * useDefaultValue           thrpt   25  3701103280.943 ±  71561673.246  ops/s
 *
 * useExplicitVolatileValue  thrpt   25  3587656113.778 ± 150725597.145  ops/s
 * useDefaultVolatileValue   thrpt   25  3715301582.315 ±  23250778.591  ops/s
 */
public class UseDefaultValue {
    ...
    /**
     * VolatileUseExplicitInitialization sample benchmark result (JDK 12):
    ...
    @Benchmark
    @Threads(Threads.MAX)
    public void useExplicitVolatileValue() {
        new VolatileUseExplicitInitialization();
    }
    ...
    @Benchmark
    @Threads(Threads.MAX)
    public void useDefaultVolatileValue() {
        new VolatileUseDefaultInitialization();
    }
    ...
    @Benchmark
    @Threads(Threads.MAX)
    public void UseExplicitValue() {
        new UseExplicitInitialization();
    }
    ...
    public void useDefaultValue() {
        new UseDefaultInitialization();
    }

    /**
     * Sample class with assignment for a volatile field.
     */
    private class VolatileUseExplicitInitialization {
    ...
    /**
     * Sample class without assignment for a volatile field.
     */
    private class VolatileUseDefaultInitialization {
    ...
    /**
     * Sample class with assignment for a field.
     */
    private class UseExplicitInitialization {
    ...
    /**
     * Sample class without assignment for a field.
     */
    private class UseDefaultInitialization {
        private boolean d;
